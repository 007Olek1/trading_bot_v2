...
class TradingBotV2:
    ...
    async def start(self):
        ...
        try:
            ...
            # Основной торговый цикл - СИНХРОНИЗАЦИЯ С ЗАКРЫТИЕМ 15-МИН СВЕЧЕЙ!
            # Запускаем каждые 15 минут в :00, :15, :30, :45
            scheduler.add_job(
                self.trading_loop,
                'cron',
    ...
    async def trading_loop(self):
        ...
        try:
            ...
            symbols = await exchange_manager.get_top_volume_symbols(top_n=300)
