...
class Config:
    ...
    COOLDOWN_AFTER_TRADE_SECONDS = 43200  # 12 часов после сделки (увеличено с 30 мин)
    MAX_TRADES_PER_DAY = 5            # Максимум 5 сделок/день (было 10)
    
    # ========================================
    # 🔍 ФИЛЬТРЫ СИГНАЛОВ (СТРОГИЕ!)
    # ========================================
    MIN_CONFIDENCE_PERCENT = 95        # 95% минимум (только лучшие сигналы!)
    MIN_SIGNAL_STRENGTH = 0.90         # 90% сила сигнала
    
    # ДОПОЛНИТЕЛЬНЫЕ ФИЛЬТРЫ ДЛЯ КАЧЕСТВА:
    MIN_VOLUME_24H = 5000000           # Минимум $5M объём за 24ч
    MIN_PRICE = 0.01                   # Минимум $0.01 за монету
    MAX_SPREAD_PERCENT = 0.5           # Максимум 0.5% спред
    
    # ТРЕБОВАНИЯ К СИГНАЛУ:
    MIN_INDICATORS_AGREE = 4           # Минимум 4 из 5 индикаторов согласны
