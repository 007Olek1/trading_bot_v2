...
class Config:
    ...
    # ========================================
    # 🔍 ФИЛЬТРЫ СИГНАЛОВ (ОЧЕНЬ СТРОГИЕ!)
    # ========================================
    MIN_CONFIDENCE_PERCENT = 98        # 98% минимум (ТОЛЬКО ЛУЧШИЕ!)
    MIN_SIGNAL_STRENGTH = 0.95         # 95% сила сигнала (КРИТИЧНО!)
    ...
    MIN_INDICATORS_AGREE = 5           # Минимум 5 индикаторов (УЖЕСТОЧЕНО!)
