...
# Улучшенный селектор символов с фильтрацией ликвидности
...
class TradingBotV2:
    ...
    async def start(self):
        ...
        try:
            ...
            await self.send_telegram(
                ...
                f"📈 ВСЕ доступные монеты (исключая малоликвидные) | ⏰ Анализ каждые 15 мин\n"
                f"━━━━━━━━━━━━━━━━━━━━━\n"
                f"🧠 ML | 🤖 LLM {llm_status} | 👁️ Auto-Healing | 🚫 Фильтр ликвидности\n"
    ...
    async def trading_loop(self):
        ...
        try:
            ...
            # 7. Получаем ВСЕ ДОСТУПНЫЕ монеты с фильтрацией ликвидности
            logger.info("📊 Получаю все доступные монеты с фильтрацией ликвидности...")
            ...
            await self.send_telegram(
                f"🔄 *ТОРГОВЫЙ ЦИКЛ*\n\n"
                f"⏰ {current_time}\n"
                f"📊 Все доступные монеты (исключая малоликвидные)\n"
                f"🔍 Начинаю анализ...\n"
                f"⏱️ ~3 минуты"
            )
            ...
            logger.info(f"🔍 Анализ {len(symbols)} ликвидных символов...")
            ...
            await self.send_telegram(
                ...
                f"⏰ {current_time}\n"
                f"📊 Проанализировано: {len(symbols)} ликвидных монет\n"
            ...
            if not best_signal:
                ...
                f"⏰ {current_time}\n"
                f"📊 Проверено: {len(symbols)} ликвидных монет\n"
